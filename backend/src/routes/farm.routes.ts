...
router.put('/shipping', authenticate, authorizeRoles('SELLER', 'ADMIN', 'HOST'), updateShippingRate)
router.get('/admins/search-users', authenticate, authorizeRoles('SELLER', 'ADMIN', 'HOST'), searchUsersForFarm)
router.get('/admins', authenticate, authorizeRoles('SELLER', 'ADMIN', 'HOST'), getMyFarmAdmins)
router.post('/admins', authenticate, authorizeRoles('SELLER', 'ADMIN', 'HOST'), addMyFarmAdmin)
router.delete('/admins/:userId', authenticate, authorizeRoles('SELLER', 'ADMIN', 'HOST'), removeMyFarmAdmin)
...
router.post('/', authenticate, authorizeRoles('SELLER', 'ADMIN', 'HOST'), createFarm)
router.put('/', authenticate, authorizeRoles('SELLER', 'ADMIN', 'HOST'), updateFarm)
router.post('/resubmit', authenticate, authorizeRoles('SELLER', 'ADMIN', 'HOST'), resubmitFarm)
router.get('/:id/approval-logs', authenticate, authorizeRoles('ADMIN', 'HOST'), getFarmApprovalLogs)
